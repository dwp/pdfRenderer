...
class PdfGeneratorSpec extends Specification with Before{
  ...
  "PdfGenerator should be handle functionalTestCase4 and return success"  should {
  ...
  "PdfGenerator should create functionalTestCase4 PDF file" should {
    val xml = ClaimBuilder.functionalTestCase4
    val dataSource = new XmlDataSource(xml)
    PdfGenerator(dataSource).generateFrom()
    val pdfFile = new File(PdfGenerator.pdfFileLocation)
  ...
  "PdfGenerator should be handle functionalTestCase5 and return success"  should {
  ...
  "PdfGenerator should create functionalTestCase5 PDF file" should {
    val xml = ClaimBuilder.functionalTestCase5
    val dataSource = new XmlDataSource(xml)
    PdfGenerator(dataSource).generateFrom()
    val pdfFile = new File(PdfGenerator.pdfFileLocation)
  ...
  "PdfGenerator should be handle functionalTestCase6 and return success"  should {
  ...
  "PdfGenerator should create functionalTestCase6 PDF file" should {
    val xml = ClaimBuilder.functionalTestCase6
    val dataSource = new XmlDataSource(xml)
    PdfGenerator(dataSource).generateFrom()
    val pdfFile = new File(PdfGenerator.pdfFileLocation)
  ...
  "PdfGenerator should be handle functionalTestCase7 and return success"  should {
  ...
  "PdfGenerator should create functionalTestCase7 PDF file" should {
    val xml = ClaimBuilder.functionalTestCase7
    val dataSource = new XmlDataSource(xml)
    PdfGenerator(dataSource).generateFrom()
    val pdfFile = new File(PdfGenerator.pdfFileLocation)
  ...
  "PdfGenerator should be handle functionalTestCase8 and return success"  should {
  ...
  "PdfGenerator should create functionalTestCase8 PDF file" should {
    val xml = ClaimBuilder.functionalTestCase8
    val dataSource = new XmlDataSource(xml)
    PdfGenerator(dataSource).generateFrom()
    val pdfFile = new File(PdfGenerator.pdfFileLocation)
  ...
  "PdfGenerator should be handle functionalTestCase9 and return success"  should {
  ...
  "PdfGenerator should create functionalTestCase9 PDF file" should {
    val xml = ClaimBuilder.functionalTestCase9
    val dataSource = new XmlDataSource(xml)
    PdfGenerator(dataSource).generateFrom()
    val pdfFile = new File(PdfGenerator.pdfFileLocation)
