...
object XMLData extends utils.TestUtils {
  ...
  def sectionAboutEmployment(xml:Elem) = {
    ...
    val yourIncomesFields = SectionYourIncomes(xml)
    ...
    Seq (employmentTitle,
      yourIncomesFields.areYouEmployedQuestion.text+" " + yourIncomesFields.areYouEmployedAnswer.text,
  ...
  def sectionAboutSelfEmployment(xml:Elem) = {
    ...
    val yourAccounts: Seq[String] = if (yourIncomesFields.haveBeenSelfEmployedAnswer.text == "yes")
      Seq("Your accounts",
          buildQuestion(fields.selfEmployedGotAccountsQuestion.text, fields.selfEmployedGotAccountsAnswer.text),
          buildQuestion(fields.selfEmployedKnowTradingYearQuestion.text, fields.selfEmployedKnowTradingYearAnswer.text),
          buildQuestion(fields.selfEmployedTradingYearStartQuestion.text, fields.selfEmployedTradingYearStartAnswer.text),
          buildQuestion(fields.selfEmployedPaidMoneyYetQuestion.text, fields.selfEmployedPaidMoneyYetAnswer.text),
          buildQuestion(fields.selfEmployedPaidMoneyDateQuestion.text, fields.selfEmployedPaidMoneyDateAnswer.text)
      )
      else Seq()

    Seq ("Part 6 - About Self Employment",
         buildQuestion(yourIncomesFields.haveBeenSelfEmployedQuestion.text, yourIncomesFields.haveBeenSelfEmployedAnswer.text),
         "Your job",
         buildQuestion(fields.selfEmployedNowQuestion.text, fields.selfEmployedNowAnswer.text),
         buildQuestion(fields.selfEmployedMoreThanYearAgoQuestion.text, fields.selfEmployedMoreThanYearAgoAnswer.text),
         buildQuestion(fields.selfEmployedDateStartedQuestion.text, fields.selfEmployedDateStartedAnswer.text),
         buildQuestion(fields.selfEmployedDateEndedQuestion.text, fields.selfEmployedDateEndedAnswer.text)) ++
    yourAccounts ++
    Seq ("Pension and expenses",
         buildQuestion(fields.selfEmployedPaidForPensionQuestion.text, fields.selfEmployedPaidForPensionAnswer.text),
         buildQuestion(fields.selfEmployedPensionExpensesQuestion.text, fields.selfEmployedPensionExpensesAnswer.text),
         buildQuestion(fields.selfEmployedPaidForJobExpensesQuestion.text, fields.selfEmployedPaidForJobExpensesAnswer.text),
         buildQuestion(fields.selfEmployedJobExpensesQuestion.text, fields.selfEmployedJobExpensesAnswer.text)
