...
case class SectionAboutSelfEmployment(xml: Elem) {
  ...
  val doYouKnowYourTaxYearQuestion = rootPath  \\ "SelfEmployment" \\ "RecentJobDetails" \\ "DoYouKnowYourTaxYear" \\ "QuestionLabel"
  val doYouKnowYourTaxYearAnswer = rootPath  \\ "SelfEmployment" \\ "RecentJobDetails" \\ "DoYouKnowYourTaxYear" \\ "Answer"
